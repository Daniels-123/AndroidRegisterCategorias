...
public class DependenciasAdministrativas extends AppCompatActivity implements ExampleAdaptor.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(R.string.dependencias2);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            mExampleAdaptor = new ExampleAdaptor(DependenciasAdministrativas.this, mexampleItems);
                            mRecyclerView.setAdapter(mExampleAdaptor);
                            mExampleAdaptor.setOnClickItemListener(DependenciasAdministrativas.this );
