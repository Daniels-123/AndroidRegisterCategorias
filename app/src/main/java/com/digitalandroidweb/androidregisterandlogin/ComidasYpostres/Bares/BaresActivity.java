...
public class BaresActivity extends AppCompatActivity implements ExampleAdaptor.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.recycler_view_bares);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            mExampleAdaptor = new ExampleAdaptor(BaresActivity.this, mexampleItems);
                            mRecyclerView.setAdapter(mExampleAdaptor);
                            mExampleAdaptor.setOnClickItemListener(BaresActivity.this );
