package com.digitalandroidweb.androidregisterandlogin.ComidasYpostres.ComidaVegetariana;
...
public class ComidaVegetarianaDetail extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_comida_vegetariana);
        ...
        ImageView imageView = findViewById(R.id.image_view_detail_comida_vegetariana);
        TextView textViewNombre = findViewById(R.id.text_view_nombre_det_comida_vegetariana);
        TextView textViewDesc = findViewById(R.id.text_view_descrip_det_comida_vegetariana);
        TextView textViewDire = findViewById(R.id.text_view_direccion_det_comida_vegetariana);
        TextView textViewTel = findViewById(R.id.text_view_telefono_det_comida_vegetariana);
