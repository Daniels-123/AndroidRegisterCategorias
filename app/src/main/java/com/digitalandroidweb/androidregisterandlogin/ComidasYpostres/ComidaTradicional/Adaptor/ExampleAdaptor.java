package com.digitalandroidweb.androidregisterandlogin.ComidasYpostres.ComidaTradicional.Adaptor;
...
public class ExampleAdaptor extends RecyclerView.Adapter<ExampleAdaptor.ExampleViewHolder> {
    ...
    public ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.example_item_comida_tradicional, parent, false);
    ...
    public class ExampleViewHolder extends RecyclerView.ViewHolder{
        ...
        public ExampleViewHolder(View itemView) {
            super(itemView);
            mImageView = itemView.findViewById(R.id.image_view_comida_tradicional);
            mTextViewCreator = itemView.findViewById(R.id.text_view_creator_comida_tradicional);
            mTextViewDescription= itemView.findViewById(R.id.text_view_description_comida_tradicional);
