package com.digitalandroidweb.androidregisterandlogin.ComidasYpostres.ComidaTradicional;
...
public class ComidaTradicionalDetail extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_comida_tradicional);
        ...
        ImageView imageView = findViewById(R.id.image_view_detail_comida_tradicional);
        TextView textViewNombre = findViewById(R.id.text_view_nombre_det_comida_tradicional);
        TextView textViewDesc = findViewById(R.id.text_view_descrip_det_comida_tradicional);
        TextView textViewDire = findViewById(R.id.text_view_direccion_det_comida_tradicional);
        TextView textViewTel = findViewById(R.id.text_view_telefono_det_comida_tradicional);
