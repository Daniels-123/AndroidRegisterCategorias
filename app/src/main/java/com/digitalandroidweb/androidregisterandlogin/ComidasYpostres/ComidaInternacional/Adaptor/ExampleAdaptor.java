package com.digitalandroidweb.androidregisterandlogin.ComidasYpostres.ComidaInternacional.Adaptor;
...
public class ExampleAdaptor extends RecyclerView.Adapter<ExampleAdaptor.ExampleViewHolder> {
    ...
    public ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.example_item_comida_internacional, parent, false);
    ...
    public class ExampleViewHolder extends RecyclerView.ViewHolder{
        ...
        public ExampleViewHolder(View itemView) {
            super(itemView);
            mImageView = itemView.findViewById(R.id.image_view_comida_internacional);
            mTextViewCreator = itemView.findViewById(R.id.text_view_creator_comida_internacional);
            mTextViewDescription= itemView.findViewById(R.id.text_view_description_comida_internacional);
