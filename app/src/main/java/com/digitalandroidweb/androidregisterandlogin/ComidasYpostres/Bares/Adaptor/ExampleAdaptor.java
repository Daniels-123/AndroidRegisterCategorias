...
public class ExampleAdaptor extends RecyclerView.Adapter<ExampleAdaptor.ExampleViewHolder> {
    ...
    public ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.example_item_bares, parent, false);
    ...
    public class ExampleViewHolder extends RecyclerView.ViewHolder{
        ...
        public ExampleViewHolder(View itemView) {
            super(itemView);
            mImageView = itemView.findViewById(R.id.image_view_bares);
            mTextViewCreator = itemView.findViewById(R.id.text_view_creator_bares);
            mTextViewDescription= itemView.findViewById(R.id.text_view_description_bares);
